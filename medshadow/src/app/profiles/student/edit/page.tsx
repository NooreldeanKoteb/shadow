          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
            <div className="md:flex">
              ...
              <div className="md:w-1/3 bg-[#14213D] p-8 text-white flex flex-col items-center justify-start">
                <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-white mb-6 shadow-lg">
                  <Image
                ...
                <div className="w-full">
                  <label htmlFor="profile-image" className="block text-sm font-medium text-white/90 mb-2">
                  ...
                  <input
                    ...
                    className="block w-full text-sm text-white/90 
                      ...
                      file:bg-white file:text-[#14213D]
                      hover:file:bg-white/90 file:cursor-pointer
                      focus:outline-none"
                  />
                </div>
              </div>
